...
|      3 | SVM (RBF)                    | Strong balanced benchmark profile | Requires scenario-specific tuning | Static OOS screening and operational planning |
|      4 | Existing Repo Model (Hybrid) | Strong balanced benchmark profile | Requires scenario-specific tuning | Static OOS screening and operational planning |
...
|      6 | XGBoost/LightGBM/HistGB      | Strong balanced benchmark profile | Requires scenario-specific tuning | Static OOS screening and operational planning |